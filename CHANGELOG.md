...
- chore(repokeeper): Cycle 218 — apps/web/index.html Prettier format fix, doc refresh (findings, active-tasks, knowledge-review, CHANGELOG), quality verification (typecheck ✅ lint ✅ build ✅ format ✅ tests 1,813/1,813 ✅ — 744 web + 443 API + 626 shared)
...
- feat(ux): add subtle breathing pulse animation to skeleton loader logo
