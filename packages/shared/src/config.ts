...
// ============================================================================
// Template Generator CSS Constants
// Centralized colors, sizes, and design tokens used in project template
// generators (static HTML/CSS, React, etc.) to eliminate hardcoded CSS
// values from template source code.
// Flexy says: No hardcoded hex colors, rgba values, or magic CSS numbers
// in template generators!
// Usage: import { TEMPLATE_CSS_COLORS, TEMPLATE_CSS_VALUES } from "@blueprint/shared";
//        `color: ${TEMPLATE_CSS_COLORS.BODY_TEXT};`
// ============================================================================

/**
 * Template Generator CSS Color Tokens
 * Centralized source of truth for hex/rgba color values used in project
 * template CSS generators. Ensures consistent color palette across all
