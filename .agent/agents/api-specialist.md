...
permissions:
  bash:
    ...
    "*": allow
memory:
  - ${AGENT_MEMORY_DIR:-.agent/memory}/api.md
---
...
- **Memory Ingestion**: Before starting, read `${AGENT_MEMORY_DIR:-.agent/memory}/api.md` for agreed conventions on Auth, Pagination, and Error codes.
...
- **Consult System Memory**: Read `${AGENT_MEMORY_DIR:-.agent/memory}/api.md`.
