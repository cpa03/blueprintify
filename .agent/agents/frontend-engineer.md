...
permissions:
  bash:
    ...
    "*": allow
memory:
  - ${AGENT_MEMORY_DIR:-.agent/memory}/frontend.md
---
...
- **Memory Ingestion**: Before starting, you MUST read `${AGENT_MEMORY_DIR:-.agent/memory}/frontend.md` if it exists. This file contains UI patterns and anti-patterns agreed upon by the team.
...
- **Consult System Memory**: Read `${AGENT_MEMORY_DIR:-.agent/memory}/frontend.md` to ensure visual consistency.
