...
permissions:
  bash:
    ...
    "*": allow
memory:
  - ${AGENT_MEMORY_DIR:-.agent/memory}/integration.md
---
...
- **Memory Ingestion**: Read `${AGENT_MEMORY_DIR:-.agent/memory}/integration.md` (if exists) or generally understand the CI requirements.
