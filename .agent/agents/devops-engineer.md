...
permissions:
  bash:
    ...
    "*": allow
memory:
  - ${AGENT_MEMORY_DIR:-.agent/memory}/devops.md
---
...
- **Memory Ingestion**: Before starting, read `${AGENT_MEMORY_DIR:-.agent/memory}/devops.md`.
...
- **Consult Memory**: `${AGENT_MEMORY_DIR:-.agent/memory}/devops.md` often contains deployment quirks.
