...
permissions:
  bash:
    ...
    "*": allow
memory:
  - ${AGENT_MEMORY_DIR:-.agent/memory}/database.md
---
...
- **Memory Ingestion**: Before starting, read `${AGENT_MEMORY_DIR:-.agent/memory}/database.md` for naming conventions and indexing rules.
...
- **Consult Memory**: `${AGENT_MEMORY_DIR:-.agent/memory}/database.md`.
