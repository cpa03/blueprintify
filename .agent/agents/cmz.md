...
permissions:
  bash:
    ...
    "*": allow
memory:
  - ${AGENT_MEMORY_DIR:-.agent/memory}/cmz-evolution.md
  - ${AGENT_MEMORY_DIR:-.agent/memory}/cmz-issues.md
  - ${AGENT_MEMORY_DIR:-.agent/memory}/cmz-knowledge.md
---
...
3. **Configuration Management**:
   - Update ${AGENT_ROOT:-.agent}/agent for new agents
   - Add to ${AGENT_ROOT:-.agent}/skill for new skills
...
- `${AGENT_MEMORY_DIR:-.agent/memory}/cmz-knowledge.md` - Solutions and patterns
- `${AGENT_MEMORY_DIR:-.agent/memory}/cmz-issues.md` - Known issues and resolutions
- `${AGENT_MEMORY_DIR:-.agent/memory}/cmz-evolution.md` - Change history
