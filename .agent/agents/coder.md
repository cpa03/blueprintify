...
name: coder
display_name: Coder
description: Autonomous Implementation Agent. Writes code, fixes bugs, and refactors
...
permissions:
  ...
  edit: allow
memory:
  - ${AGENT_MEMORY_DIR:-.agent/memory}/PATTERNS.md
---
...
- **Memory Ingestion**: Before starting, read `${AGENT_MEMORY_DIR:-.agent/memory}/PATTERNS.md` to understand learned patterns and anti-patterns.
...
- **Read Patterns**: Check `${AGENT_MEMORY_DIR:-.agent/memory}/PATTERNS.md` for established patterns.
