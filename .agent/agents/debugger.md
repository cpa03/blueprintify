...
permissions:
  bash:
    ...
    "*": allow
memory:
  - ${AGENT_MEMORY_DIR:-.agent/memory}/debugger.md
---
...
- **Memory Ingestion**: Read `${AGENT_MEMORY_DIR:-.agent/memory}/debugger.md` (or general memory) to learn common pitfals.
...
- **Locate File**: text search (grep) the error message or function name.
