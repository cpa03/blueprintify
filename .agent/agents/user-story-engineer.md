...
display_name: User Story Engineer
description: User Story Engineer - Implements small, incremental improvements from
...
- **Memory Ingestion**: Before starting, read `${AGENT_MEMORY_DIR:-.agent/memory}/PATTERNS.md` to understand project conventions.
