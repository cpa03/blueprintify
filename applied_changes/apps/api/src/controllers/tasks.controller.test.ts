...
describe("tasksController", () => {
  const mockRequest: TaskGenerationRequest = {
  ...
  describe("generateTasks", () => {
    it("should generate tasks stream successfully", async () => {
      ...
      const result = await tasksController.generateTasks(
        mockRequest,
        mockContext,
      );
    ...
    it("should throw error when API key is missing", async () => {
      ...
      await expect(
        tasksController.generateTasks(mockRequest, mockContextWithoutKey),
      ).rejects.toThrow();
    ...
    it("should wrap stream errors appropriately", async () => {
      ...
      await expect(
        tasksController.generateTasks(mockRequest, mockContext),
    ...
    it("should handle different blueprint content", async () => {
      const differentRequest: TaskGenerationRequest = {
