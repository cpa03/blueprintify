...
vi.mock("../services/prompts", () => ({
  ...
  buildBlueprintPrompt: vi.fn(
    (request) => `Generate blueprint for ${request.projectName}`,
  ),
}));
...
describe("generateController", () => {
  const mockRequest: BlueprintRequest = {
  ...
  describe("generateBlueprint", () => {
    it("should generate a blueprint stream successfully", async () => {
      ...
      const result = await generateController.generateBlueprint(
        mockRequest,
        mockContext,
      );
    ...
    it("should wrap stream errors appropriately", async () => {
      ...
      await expect(
        generateController.generateBlueprint(mockRequest, mockContext),
    ...
    it("should use default model when not specified", async () => {
      ...
      await generateController.generateBlueprint(
        mockRequest,
