...
import { APIError, ValidationError, ConfigurationError, AIServiceError, StreamError, ErrorCode, HttpStatusCode, createErrorResponse, errorToResponse, createSuccessResponse, isAPIError, getErrorMessage, createValidationError, createOpenAIConfigError, wrapOpenAIError, wrapStreamError, } from "../lib/errors";
describe("Error Classes", () => {
    describe("APIError", () => {
        it("should create a basic APIError", () => {
            const error = new APIError("Test error", ErrorCode.VALIDATION_ERROR, HttpStatusCode.BAD_REQUEST);
        ...
        it("should support optional details", () => {
            ...
            const error = new APIError("Test error", ErrorCode.VALIDATION_ERROR, HttpStatusCode.BAD_REQUEST, details);
...
describe("Response Builders", () => {
    describe("createErrorResponse", () => {
        it("should create a standardized error response", () => {
            const response = createErrorResponse(ErrorCode.VALIDATION_ERROR, "Invalid input", HttpStatusCode.BAD_REQUEST);
        ...
        it("should include optional details", () => {
            const details = { field: "testField" };
            const response = createErrorResponse(ErrorCode.VALIDATION_ERROR, "Invalid input", HttpStatusCode.BAD_REQUEST, details);
    ...
    describe("errorToResponse", () => {
        it("should convert an APIError to error response", () => {
            const apiError = new APIError("Test error", ErrorCode.VALIDATION_ERROR, HttpStatusCode.BAD_REQUEST);
...
describe("Type Guards", () => {
    describe("isAPIError", () => {
        it("should return true for APIError instances", () => {
            const error = new APIError("Test", ErrorCode.VALIDATION_ERROR, HttpStatusCode.BAD_REQUEST);
