...
- README.md: Removed incorrect Prettier and format script references (not available as npm scripts)
- PR #1005: Fix README - remove incorrect Prettier and format script references
- Task documentation sprawl fix - reorganized task tracking
  - Reduced task.md from 519 lines to 31 lines
  - Created completed-tasks-2026-q1.md for archived tasks
  - Created active-tasks.md for current work
  - Added task lifecycle documentation to repo-rules.md
