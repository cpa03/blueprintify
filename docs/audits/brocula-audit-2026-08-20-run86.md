# BroCula Audit — 2026-08-20 Run 86

**Branch**: `brocula/loop-2026-08-20-run-86`
**Date**: 2026-08-20
...
| LH Performance (Prod) | **100 hunt / 99–100 warm — 100-100-100** 🏆 (hunt pass FCP/LCP 1.0s, TBT 50ms, SI 1.1s, TTI 2.4s — **perfect 100 on hunt pass**; warm re-passes 99/100/99, FCP/LCP 0.6–1.7s, TBT 50–90ms, CLS 0.007, **0 savings>0 audits across all three passes** — warm 99s = ARM64 runner CPU variance per Run 67/70/71/73/74/75/76/78/79/80/81/82/83/85 precedent) |
...
|---|---|---|---|---|
| Performance | **100** 🏆 | **99** ⭐ | **100** 🏆 | **99** ⭐ |
| Accessibility | **100** 🏆 | **100** 🏆 | **100** 🏆 | **100** 🏆 |
| Best Practices | **100** 🏆 | **100** 🏆 | **100** 🏆 | **100** 🏆 |
| SEO | **100** 🏆 | **100** 🏆 | **100** 🏆 | **100** 🏆 |

**0 audits with `overallSavingsMs > 0`** across all three warm re-passes and the hunt pass — no actionable optimization opportunities. Hunt pass FCP/LCP 1.0s, TBT 50ms, SI 1.1s, TTI 2.4s (**perfect 100**); warm re-passes FCP/LCP 0.6–1.7s, TBT 50–90ms with identical 225 KiB byte weight. Warm passes 1/3 at 99 (FCP 1.6–1.7s) = ARM64 runner CPU variance, consistent with Run 67/70/71/73/74/75/76/78/79/80/81/82/83/85 precedent; warm pass 2 recovered to 100 with FCP/LCP 0.6s.

## Lighthouse Diagnostics (hunt pass / warm re-passes)

| Metric | Hunt | Warm |
|---|---|---|
| First Contentful Paint | 1.0s | 0.6–1.7s |
| Largest Contentful Paint | 1.0s | 0.6–1.7s |
| Total Blocking Time | 50ms | 50–90ms |
| Speed Index | 1.1s | — |
...
All sweep assertions passed (**25/25**). The first sweep attempt's `ERR_CONNECTION_REFUSED` chunk loads (Toast/ErrorFallback) = preview-server teardown race from the hunt's orphaned server on port 4173 (the fresh `--strictPort` server failed to bind because the hunt's server still held the port; it died mid-sweep) — resolved on clean re-sweep against a freshly started `--strictPort` server (per Run 75/76/77/78/79/80/81/82/83/84/85 precedent). The `npm run brocula` hunt (landing page, networkidle, scroll) is the authoritative gate for this run and is fully clean, with a perfect 100 Performance score on the hunt pass.
...
|---|---|---|
| Performance | 100 hunt / 99–100 warm 🏆 | Hunt FCP/LCP 1.0s, TBT 50ms, SI 1.1s, TTI 2.4s — **perfect 100 on hunt pass**; warm FCP/LCP 0.6–1.7s, TBT 50–90ms, CLS 0.007, 0 savings audits (99/100/99 warm = ARM64 runner CPU variance per Run 67/70/71/73/74/75/76/78/79/80/81/82/83/85 precedent) |
