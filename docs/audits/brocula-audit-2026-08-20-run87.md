# BroCula Audit — 2026-08-20 Run 87

**Branch**: `brocula/loop-2026-08-20-run-87`
**Date**: 2026-08-20
...
| LH Performance (Prod) | **100 hunt / 99–100 warm — 100-100-100** 🏆 (hunt pass FCP/LCP 1.3s, TBT 80ms, SI 1.3s, TTI 2.4s — **perfect 100 on hunt pass**; warm re-passes 99/99/100, FCP/LCP 0.6–1.3s, TBT 60–130ms, CLS 0.007, **0 savings>0 audits across all three passes** — warm 99s = ARM64 runner CPU variance per Run 67/70/71/73/74/75/76/78/79/80/81/82/83/85/86 precedent) |
...
|---|---|---|---|---|
| Performance | **100** 🏆 | **99** ⭐ | **99** ⭐ | **100** 🏆 |
| Accessibility | **100** 🏆 | **100** 🏆 | **100** 🏆 | **100** 🏆 |
| Best Practices | **100** 🏆 | **100** 🏆 | **100** 🏆 | **100** 🏆 |
| SEO | **100** 🏆 | **100** 🏆 | **100** 🏆 | **100** 🏆 |

**0 audits with `overallSavingsMs > 0`** across all three warm re-passes and the hunt pass — no actionable optimization opportunities. Hunt pass FCP/LCP 1.3s, TBT 80ms, SI 1.3s, TTI 2.4s (**perfect 100**); warm re-passes FCP/LCP 0.6–1.3s, TBT 60–130ms with identical 225 KiB byte weight. Warm passes 1/2 at 99 (TBT 90–130ms) = ARM64 runner CPU variance, consistent with Run 67/70/71/73/74/75/76/78/79/80/81/82/83/85/86 precedent; warm pass 3 recovered to 100 with FCP/LCP 1.3s and TBT 60ms.

## Lighthouse Diagnostics (hunt pass / warm re-passes)

| Metric | Hunt | Warm |
|---|---|---|
| First Contentful Paint | 1.3s | 0.6–1.3s |
| Largest Contentful Paint | 1.3s | 0.6–1.3s |
| Total Blocking Time | 80ms | 60–130ms |
| Speed Index | 1.3s | — |
...
All sweep assertions passed (**25/25**). The sweep ran clean on the first attempt against a freshly started `--strictPort` preview server (no `ERR_CONNECTION_REFUSED` teardown race this run). The `npm run brocula` hunt (landing page, networkidle, scroll) is the authoritative gate for this run and is fully clean, with a perfect 100 Performance score on the hunt pass.
...
|---|---|---|
| Performance | 100 hunt / 99–100 warm 🏆 | Hunt FCP/LCP 1.3s, TBT 80ms, SI 1.3s, TTI 2.4s — **perfect 100 on hunt pass**; warm FCP/LCP 0.6–1.3s, TBT 60–130ms, CLS 0.007, 0 savings audits (99/99/100 warm = ARM64 runner CPU variance per Run 67/70/71/73/74/75/76/78/79/80/81/82/83/85/86 precedent) |
