...
export const TIMEOUTS = {
  ...
  OBSERVER_DISCONNECT: SHARED_UI_TIMEOUTS.OBSERVER_DISCONNECT,
} as const;
...
export const STORAGE_CONFIG = {
  ...
  QUOTA_WARNING_THRESHOLD_KB: STORAGE_LOCAL_DEFAULTS.QUOTA_WARNING_THRESHOLD_KB,
  MAX_LATENCY_MEASUREMENTS: STORAGE_LOCAL_DEFAULTS.MAX_LATENCY_MEASUREMENTS,
  DEFAULT_MAX_RETRIES: STORAGE_LOCAL_DEFAULTS.DEFAULT_MAX_RETRIES,
  DEFAULT_RETRY_DELAY_MS: STORAGE_LOCAL_DEFAULTS.DEFAULT_RETRY_DELAY_MS,
  QUOTA_CACHE_TTL_MS: STORAGE_LOCAL_DEFAULTS.QUOTA_CACHE_TTL_MS,
  CURRENT_SCHEMA_VERSION: SHARED_STORAGE_CONFIG.CURRENT_SCHEMA_VERSION,
  LEGACY_SCHEMA_VERSION: SHARED_STORAGE_CONFIG.LEGACY_SCHEMA_VERSION,
...
export const AUTO_SAVE_CONFIG = {
  ...
  DEFAULT_DELAY: STORAGE_LOCAL_DEFAULTS.AUTO_SAVE_DELAY_MS,
} as const;
