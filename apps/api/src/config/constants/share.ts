...
export const SHARE_CONFIG = {
  ...
  /** Regex pattern for valid share IDs (alphanumeric, URL-safe, no injection risk) */
...
export const SHARE_ERROR_MESSAGES = {
  ...
  PASSPHRASE_REQUIRED: SHARE_MESSAGES.PASSPHRASE_REQUIRED,
  INVALID_PASSPHRASE: SHARE_MESSAGES.INVALID_PASSPHRASE,
  PASSPHRASE_RATE_LIMIT: SHARE_MESSAGES.PASSPHRASE_RATE_LIMIT,
} as const;
