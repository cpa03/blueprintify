...
-- Description: Create initial database schema for Blueprintify
-- Created: 2026-02-05
-- Database: Cloudflare D1 (SQLite)

-- Run this migration with: wrangler d1 execute blueprintify-db --file=migrations/001_initial_schema.sql
